...
export default function MainMap() {
    ...
    useEffect(() => {
        ...
        const setupFlow = async () => {
            ...
            setActiveFlowType('ROADSIDE_ASSISTANCE');
            const restored = await restoreActiveBookingForFlow('ROADSIDE_ASSISTANCE');
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            ...
            try {
                ...
                Alert.alert("Error", "Could not load roadside data. Please check backend/API URL and try again.");
            } finally {
            ...
            <View style={styles.container}>
                ...
                {isFlowReady && (
                    <ServiceBookingSheet
                        ...
                        vehicles={filteredCarVehicles}
                        isInitialLoading={isInitialLoading}
                        pinnedLocation={pinnedLocation}
                        isGeocoding={isGeocoding}
                        onPinLocationRequest={() => { }} // Controlled by stage
                        onConfirmPin={handleConfirmPin}
                        bookingServiceType="ROADSIDE_ASSISTANCE"
                    />
                )}
            </View>
