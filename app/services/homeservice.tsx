...
export default function HomeServiceMap() {
    ...
    useEffect(() => {
        ...
        const setupFlow = async () => {
            ...
            setActiveFlowType('HOME_SERVICE');
            const restored = await restoreActiveBookingForFlow('HOME_SERVICE');
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            ...
            try {
                ...
                Alert.alert("Error", "Could not load home service data. Please check backend/API URL and try again.");
            } finally {
