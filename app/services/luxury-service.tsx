//app/services/luxury-service.tsx
...
export default function LuxuryServiceMap() {
    ...
    // Assuming Luxury uses all vehicles or maybe filters? 
    // original code didn't show a filter in the snippet. 
    // Defaulting to all vehicles.
    ...
    useEffect(() => {
        ...
        const setupFlow = async () => {
            ...
            setActiveFlowType('LUXURY');
            const restored = await restoreActiveBookingForFlow('LUXURY');
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            ...
            try {
                ...
                Alert.alert("Error", "Could not load luxury service data. Please check backend/API URL and try again.");
            } finally {
    ...
    const handleConfirmPin = () => {
        if (pinnedLocation && pinnedLocation.latitude && pinnedLocation.longitude) {
            ...
            startBooking({
                serviceType: 'LUXURY', // Updated for Luxury Service
