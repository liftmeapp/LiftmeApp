...
export default function EVServiceMap() {
    ...
    useEffect(() => {
        ...
        const setupFlow = async () => {
            ...
            setActiveFlowType('ELECTRIC_VEHICLE');
            const restored = await restoreActiveBookingForFlow('ELECTRIC_VEHICLE');
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            ...
            try {
                ...
                Alert.alert("Error", "Could not load EV service data. Please check backend/API URL and try again.");
            } finally {
