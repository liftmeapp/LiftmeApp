...
import { ActivityIndicator, Alert, FlatList, Linking, RefreshControl, SafeAreaView, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
...
const OrderCard = ({ booking }: { booking: any }) => {
    ...
    return (
        <View style={styles.card}>
            ...
            <TouchableOpacity style={styles.callButton} onPress={handleCall} disabled={!provider?.contactPhone}>
...
export default function OrdersScreen() {
    ...
    useEffect(() => {
        ...
        const clerkId = getToken.toString(); // Simplified for example, use actual clerkId
        ...
        <SafeAreaView style={styles.container}>
            ...
            {loading ? (
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => <OrderCard booking={item} />}
...
const styles = StyleSheet.create({
    ...
    header: { paddingHorizontal: 20, paddingVertical: 15, borderBottomWidth: 1, borderBottomColor: '#e0e0e0', backgroundColor: '#fff' },
