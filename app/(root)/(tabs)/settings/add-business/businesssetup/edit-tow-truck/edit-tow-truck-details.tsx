      ...
      <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.sectionHeader}>
            <Text style={styles.subheading}>Service Pricing</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  subheading: { fontSize: 16, fontWeight: '700', color: '#005C70' },
  ...
  pickerItem: { height: 48, fontSize: 15 },
  ...
  serviceName: { fontSize: 15, color: '#333', fontWeight: '500' },
  priceInputRow: { flexDirection: 'row', alignItems: 'center', marginTop: 8, paddingLeft: 0 },
